...
export default async function JadualPage({
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6">
      ...
      <div className="mb-4 flex items-center justify-between rounded-2xl border border-slate-200/70 bg-white p-2 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <Link
          href={`/jadual?date=${prevDate}`}
          className="rounded-full px-3 py-2 text-sm font-medium text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800"
        >
          ← Sebelum
        </Link>
