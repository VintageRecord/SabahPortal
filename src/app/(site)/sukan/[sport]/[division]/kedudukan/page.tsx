...
export default async function DivisionStandingsPage({
  ...
  return (
    <div>
      ...
      {!anyPlayed && (
        <p className="mb-4 rounded-lg bg-amber-50 px-3 py-2 text-xs text-amber-700 dark:bg-amber-950 dark:text-amber-300">
        ...
        <table className="w-full min-w-[560px] border-collapse text-sm">
          ...
          <tbody>
            {standings.map((row, idx) => (
              ...
              >
                <td className="px-3 py-2 text-center text-xs font-semibold text-slate-400">
                  {idx + 1}
                </td>
